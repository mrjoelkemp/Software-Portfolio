...
namespace Gesture
{
    class Sprite
    {
        ...
        public void UpdateBoundingBox()
        {
            ...
            Vector3 min = new Vector3((int)position.X - center.X, (int)position.Y - center.Y, 0);
            //Bottom right corner of the sprite
            Vector3 max = new Vector3((int)position.X + texture.Width - center.X, (int)position.Y + texture.Height - center.Y, 0);
