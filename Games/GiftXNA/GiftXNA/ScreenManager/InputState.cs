...
namespace Gesture
{
    ...
    public class InputState
    {
        ...
        /// <summary>
        /// Checks for a "see player stats" input action, from any player,
        /// on either keyboard or gamepad
        /// </summary>
        public bool SeeStats
        {
            get
            {
        ...
        public bool IsPauseGame(PlayerIndex controllingPlayer)
        {
            ...
            return IsNewKeyPress(Keys.Escape, controllingPlayer) ||
                   IsNewKeyPress(Keys.P, controllingPlayer) ||
                   IsNewButtonPress(Buttons.Back, controllingPlayer) ||
                   IsNewButtonPress(Buttons.Start, controllingPlayer);
        }
