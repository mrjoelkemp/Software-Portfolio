...
namespace Gesture
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        /// <summary>
        /// The color to draw the sprite associated with the particle system.
        /// Allows us to change the color of the sprite's pixels to vary the 
        /// particle system.
        /// Defaulted to White, so that the texture pixel-color isn't changed.
        /// </summary>
        public Color color = Color.White;

        /// <summary>
        /// Whether or not the particle system should collide with other objects.
        /// </summary>
        public bool isCollidable = false;

        /// <summary>
        /// Whether or not a collidable particle system blocks
        /// enemy bullets.
        /// </summary>
        ...
        /// <summary>
        /// Damage points that the particle system does to collided objects.
        /// </summary>
        public int damage;
        ...
        /// <summary>
        /// Whether or not the particle system has finished rendering.
        /// </summary>
        ...
        /// <summary>
        /// we want to call InitializeConstants to let subclasses 
        /// set the constants that we'll use.
        /// 
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = 
                Defines.randomGenerator.Next(minNumParticles, maxNumParticles);
        ...
        /// <summary>
        /// Returns a list of active particles' bounding spheres.
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (Particle p in particles)
            {
                ...
                if (isCollidable)
                {    
                    //Scale the initial size of the image, not the scaled radius
                    ...
                    brush.CreateCircle(p.Sphere.Radius, 100);
                    brush.Position = new Vector2();
                    brush.Position.X = p.Sphere.Center.X;
                    brush.Position.Y = p.Sphere.Center.Y;
