...
Begin VB.Form frmAttorneyNew 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.CommandButton cmdNewCase 
         Height          =   615
         Left            =   6960
         Picture         =   "frmAttorneyNew.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton cmdNotes 
         Height          =   615
         Left            =   6240
         Picture         =   "frmAttorneyNew.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Notes"
         Top             =   240
      ...
      Begin VB.CommandButton cmdCases 
         Height          =   615
         Left            =   5520
         Picture         =   "frmAttorneyNew.frx":1194
         Style           =   1  'Graphical
         TabIndex        =   20
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbDay 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmAttorneyNew.frx":1A5E
         Left            =   1680
         List            =   "frmAttorneyNew.frx":1A60
         TabIndex        =   4
         Text            =   "mm"
         ToolTipText     =   "Day"
         Top             =   1680
      ...
      Begin VB.ComboBox cbYear 
         Height          =   315
         ItemData        =   "frmAttorneyNew.frx":1A62
         Left            =   2880
         List            =   "frmAttorneyNew.frx":1A64
         TabIndex        =   6
         Text            =   "yyyy"
         ToolTipText     =   "Year"
         Top             =   1680
   ...
   End
End
Attribute VB_Name = "frmAttorneyNew"
...
Private Sub cmdCases_Click()
    g_CaseViewMode = "ATTORNEY"
    frmCases.Show
End Sub

Private Sub cmdNewCase_Click()
    g_CaseMode = "NEW"
    g_CaseCallingModule = "frmAttorneyNew"
    frmCaseNew.clear_Fields
    frmCaseNew.Show
End Sub

Private Sub cmdNotes_Click()
    'If the user is viewing details, they can only view notes,
    'not modify or create
    If g_AttorneyMode = "VIEW" Then
        g_NoteMode = "VIEW"
    Else
        g_NoteMode = "NEW"
    End If
    
    'Set so you can return to this screen when finished with notes
    g_NoteCallingModule = "frmAttorneyNew"
...
Dim w_Recordset As New Recordset
    ...
    'Perform Database operation
     With w_Recordset
       .Open w_SQL, frmMDI.SQLConnect, adOpenForwardOnly, adLockReadOnly
        ...
        'If the Attorney ID creates a Duplicate Entry
        If Err.Number = -2147467259 Then
            'Display Error Msg
            MsgBox "Attorney ID Already Exists" & vbCr, vbExclamation, "Duplicate ID"
            Exit Function
        End If
    ...
    system_db.write_systemLog g_AttorneyMode, dbModuleAttorney, sAttorneyID.Text
...
Public Sub deleteAttorney()
'Purpose:   Called by frmMDI when user clicks the delete toolbar button
'           FrmMDI sets the global attorney id (ie, the attorney that
'           was selected in frmAttorneySearch)
Dim w_SQL       As String
Dim w_Recordset As New Recordset
Dim confMsg     As Integer
    ...
    If confMsg = 1 Then
        ...
        w_SQL = "Delete * From attorneys Where attorneyid=" & Chr(34) & g_AttorneyID & Chr(34) & ";"
        ...
        With w_Recordset
            ...
            'Create query to delete attorney notes according to attorney id
            w_SQL = "Delete * from notes where itemid =" & Chr(34) & g_AttorneyID & Chr(34) & ";"
        ...
        'Show success
        MsgBox "Attorney Information Deleted Successfully", vbOKOnly, "Deletion Confirmation"
        
        'Enter System Log
        system_db.write_systemLog g_SystemDelete, dbModuleAttorney, g_AttorneyID
...
errHandler:
MsgBox "Error In Deleting Attorney", vbCritical, "Error"
    
End Sub

Public Function returnToPreviousScreen()
    frmAttorneyNew.Hide
...
'Purpose: Return appropriate SQL Query based on typeSQL
'TypeSQL Values: 'INSERT', 'MODIFY', 'DELETE'
Dim w_SQL As String
Dim w_Recordset As New Recordset
...
Dim sexCode As String
    ...
    Select Case typeSQL
        ...
        Case "INSERT"
            getSQL = "Insert into attorneys values ('" & _
                sAttorneyID.Text & "', '" & _
                sLastName.Text & "', '" & _
                sFirstName.Text & "', '" & _
                sOtherName.Text & "', '" & _
        ...
        Case "MODIFY"
            getSQL = "Update attorneys Set " & _
                ...
                " Where attorneyid=" & Chr(34) & sAttorneyID.Text & Chr(34) & ";"
    End Select
    
End Function

Function getCode(codeType As String)
'Purpose: Get the code of the corresponding item description
Dim w_SQL As String
Dim w_Recordset As New Recordset
...
Function showError()
    Dim errorMsg As Integer
       ...
       Select Case g_AttorneyMode
        ...
        Case "NEW"
            errorMsg = MsgBox("Attorney Information Not Entered" & vbCr & "     Please check the ID Number", 48, "Creation Error")
        Case "MODIFY"
            errorMsg = MsgBox("Attorney Information Not Modified" & vbCr & "     Database Error", 48, "Modification Error")
    End Select
...
Function showSuccess()
    Dim doneMsg As Integer
       ...
       Select Case g_AttorneyMode
        ...
        Case "NEW"
            doneMsg = MsgBox("Attorney Information Entered Successfully", 0, "Entry Confirmation")
            clear_Fields
        Case "MODIFY"
            doneMsg = MsgBox("Attorney Information Modified Successfully", 0, "Modification Confirmation")
            clear_Fields
            Hide
            showSelectScreen
...
Private Sub Form_Activate()
    ...
    sAttorneyID.Enabled = True
    
    Select Case g_AttorneyMode
        
        Case "NEW"
            lblWindow.Caption = "Attorney - Add"
            lblFunction.Caption = "Enter Attorney Details and Press Save"
             
        Case "MODIFY"
            load_Data
            'User cannot change the ID of an Attorney
            sAttorneyID.Enabled = False
            lblWindow.Caption = "Attorney - Modify Details"
            frmMDI.setSaveRecToolTip ("Modify Record")
            lblFunction.Caption = "Modify Attorney Details and Press Save"
        ...
        Case "VIEW"
            ...
            lblWindow.Caption = "Attorney - View Details"
            lblFunction.Caption = "Attorney Details Listed Below"
    End Select
...
Function setFormProperties()
    'Load Combo each time in case user makes
    'new parameters when form has already been loaded
    Load_Combo_Info
    
    frmMDI.showModuleButtons
    isRightScreenToHide ("frmAttorneyNew")
    'Set current screen
    setCurrentScreen ("frmAttorneyNew")
    frmMDI.hideSelfModuleButton

    'Reset the change flag
    attorneyChange = False
...
Dim w_Recordset As New Recordset
    ...
    w_SQL = "select * from attorneys where attorneyid = '" & g_AttorneyID & "'"
    With w_Recordset
        .Open w_SQL, frmMDI.SQLConnect, adOpenForwardOnly, adLockReadOnly
        If Not .EOF Then
            sAttorneyID.Text = !attorneyid
...
errHandler:
Dim errorMsg As Integer
    errorMsg = MsgBox("Attorney Information Not Loaded", 0, "Error")
...
'Purpose: Set the text of the passed in combo to the description field
Dim w_Recordset As New Recordset
...
'Purpose: Load the DB elements for certain combos
Dim w_SQL As String
Dim w_Recordset As New Recordset
...
'Purpose: Populate the passed in combo
Dim w_Recordset As New Recordset
...
Private Sub sAttorneyID_Change()
    attorneyChange = True
End Sub
